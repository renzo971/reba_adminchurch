<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="subject" class="form-control @error('subject') is-invalid @enderror" value="{{ old('subject', $contact?->subject) }}" id="subject" placeholder="Subject">
            {!! $errors->first('subject', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="message" class="form-label">{{ __('Message') }}</label>
            <input type="text" name="message" class="form-control @error('message') is-invalid @enderror" value="{{ old('message', $contact?->message) }}" id="message" placeholder="Message">

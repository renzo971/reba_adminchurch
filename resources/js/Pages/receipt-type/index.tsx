...
export default function Index({ auth, receiptTypes }: any) {
    ...
    const handleDelete = (id: number) => {
        if (
            ...
            destroy(route("receipt-types.destroy", id));
        }
    };
            ...
            <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                <div className="pb-3 sm:flex sm:items-center">
                    ...
                    <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <Link
                            type="button"
                            href={route("receipt-types.create")}
                ...
                <div className="max-w-full overflow-x-auto">
                    <table className="w-full table-auto">
                        <thead>
                            <tr>
                                <th className="py-3 pl-4 pr-3 font-medium tracking-wide text-left text-black dark:text-white">
                                    Nro
                                </th>
